...
export const objectToQueryString = (obj) => stringify(obj, { arrayFormat: "indices" })

export const convertQueryWithDate = (dateParams = ["startDate", "endDate"]) => (key, value) => {
...
export const convertQueryWithDateRange = (dateRangeParam = "dateRange") => (key, value) => {
