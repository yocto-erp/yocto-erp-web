...
import { Dropdown, DropdownMenu, DropdownToggle, Nav, Navbar } from "reactstrap"
...
function Header({ companyName, isShowSignUp = true, isShowSignIn = true, isShowCart = false }) {
  const { user } = useUser()
  ...
  return (
    <div className="container-fluid">
      <Navbar className="d-print-none navbar-expand-lg ">
        ...
        <h4 className="navbar-brand text-white mr-1 mt-2 ml-5">{companyName || ""}</h4>
