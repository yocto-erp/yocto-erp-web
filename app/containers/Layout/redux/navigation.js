...
export const selectActiveItem = (state = initialState) => state.navigation.activeItem
export const selectActiveMenu = (state = initialState) => state.navigation.activeMenu
  ...
  produce(state, (draft) => {
    switch (action.type) {
      ...
      case CHANGE_SIDEBAR_VISIBILITY:
        draft.sidebarVisibility = state.sidebarVisibility === "hide" ? "show" : "hide"
        break
