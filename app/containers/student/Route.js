...
import StudentMonthlyNewPage from "./monthly-fee-new/Loadable"
...
import { STUDENT_MONTHLY_NEW_ROOT_PATH } from "./monthly-fee-new/constants"

function StudentRoutePage() {
  return (
    <Switch>
      <Route path={`${STUDENT_MONTHLY_ROOT_PATH}`} component={StudentMonthlyPage} />
      <Route path={`${STUDENT_MONTHLY_NEW_ROOT_PATH}`} component={StudentMonthlyNewPage} />
      ...
      <Route path={STUDENT_TRACKING_ROOT_PATH} component={StudentTrackingPage} />
