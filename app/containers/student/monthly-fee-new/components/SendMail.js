...
const SendMailStudentFee = ({ isOpen = false, fees = [], onClose }) => {
  ...
  const {
    ...
    api: (formData) => {
      ...
      return studentMonthlyFeeNewApi.sendEmail(
        fees,
    ...
    <Modal className="primary large" isOpen={isOpen} fade={false}>
      <form onSubmit={onSubmit} noValidate>
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className="alert alert-danger" role="alert">
                This will send email to student parent (include mother and father, if got
                information)
              </div>
            </div>
          </div>
        ...
        <ModalFooter>
          ...
          <ModalOKButton color="primary" disabled={!isValid} isLoading={isLoading} type="submit">
