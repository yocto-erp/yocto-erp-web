...
import ListWidget from "../../../components/ListWidgetNew"
      ...
      },
      {
        ...
        render: (row) => (
          <>
            ...
            <br />
            <small>
              Updated: <strong>{formatDate(new Date(row.lastUpdatedDate))}</strong>
            </small>
          </>
        ),
      },
          ...
          return (
            <>
              <p className="m-0">
                ...
                <br />
                <ShortText text={row.paidInformation} maxWidth={160} className="text-info small" />
              </p>
            </>
          )
        },
      ...
      <Route
        ...
        render={({
          ...
          <DeleteConfirmModal
            ...
            readApi={(par) => studentMonthlyFeeApi.read(par).then((resp) => resp[0])}
              ...
              if (item) {
                toast.success(
                  <span>
                    ...
                    at month <strong>{formatMonth(item.monthFee, item.yearFee)}</strong> Success
                  </span>,
                )
              }
            }}
            ...
            message={(row) => {
              ...
              return (
                <span>
                  ...
                  at month <strong>{formatMonth(row.monthFee, row.yearFee)}</strong> ?
                </span>
              )
            }}
          />
  ...
  return (
    <>
      <ListWidget
        ...
        columns={columns}
        fetchData={studentMonthlyFeeNewApi.search}
        enableSelectColumn
