...
import { isAudioMimeType, isImageMimeType, isVideoMimeType, MIME_TYPE } from "../constants"
import { COLOR } from "../../../styles/color"
import AssetPdfView from "./AssetPdfView"
import AssetVideoView from "./AssetVideoView"
import Img from "../../Img"

const AssetView = ({ asset, color = COLOR.secondary, size = 16, display = "icon" }) => {
  if (isImageMimeType(asset.mimeType)) {
    return <Img className="img-thumbnail" src={cloudAssetUrl(asset)} alt="thumbnail" />
  }
