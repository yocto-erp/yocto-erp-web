...
const CompanySelect = React.forwardRef((
  { onBlur, invalid, name, placeholder, onAdded, onChange, value, creatable = true, ...props },
  ...
  return (
    <div key={`${name}_${newCreateId}`} className={classNames({ "is-invalid": invalid })}>
      <InputGroup {...props}>
        <AsyncSelect
        ...
        {creatable ? (
          <InputGroupAddon addonType="append">
            <Button color="primary" type="button" className="pt-0 pb-0" onClick={() => open(true)}>
